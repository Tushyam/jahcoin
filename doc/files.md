...
* jahcoin.conf: contains configuration settings for jahcoind or jahcoin-qt
* jahcoind.pid: stores the process id of jahcoind while running
...
* debug.log: contains debug information and general logging generated by jahcoind or jahcoin-qt
