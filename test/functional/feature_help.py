...
"""Verify that starting jahcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start jahcoin with -h for help text")
        ...
        self.log.info("Start jahcoin with -version for version information")
