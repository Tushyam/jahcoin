...
#if defined(NDEBUG)
# error "Jahcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Jahcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s JAHC additional fees, %d delta bytes\n",
