...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jahcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jahcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jahcoin transaction") + "\n" +
              "  jahcoin-tx [options] -create [commands]   " + _("Create hex-encoded jahcoin transaction") + "\n" +
              "\n";
