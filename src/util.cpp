...
const char * const BITCOIN_CONF_FILENAME = "jahcoin.conf";
const char * const BITCOIN_PID_FILENAME = "jahcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Jahcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Jahcoin";
#else
    // Unix
    return pathRet / ".jahcoin";
#endif
#endif
}
